    ...
    --
    -- Dumping data for table `supervisr`
    --

    INSERT INTO `supervisor` (`name`, `pass`,`hoteltype`) VALUES
    ('firstone', 'first','girls');
    ...
    INSERT INTO `services` (`name`, `type`, `cost`,  `img`, `dec`) VALUES
    ('gym ', 'girl', 1200 , 'D:\nour\t3del hotel\Hotel-Management-System-NodeJS-MYSQL\public\img/gym.jpg', 'Non AC Room'),
    ('gym ', 'boy', 1200 , 'D:\nour\t3del hotel\Hotel-Management-System-NodeJS-MYSQL\public\img/gym.jpg', 'Non AC Room'),
    ...
    ('girl ', 'Double Bed', 1200, 11, '/assets/img/rooms/room1.jpg', 'Non AC Room'),
    ('boy ', 'Double Bed', 2005, 9, '/assets/img/rooms/room2.jpg', 'AC Room'),
    ('girl ', 'Single Bed', 800, 10, '/assets/img/rooms/room3.jpg', 'Non AC Room'),
    ('boy ', 'Single Bed', 1200, 10, '/assets/img/rooms/room4.jpg', 'AC Room'),
