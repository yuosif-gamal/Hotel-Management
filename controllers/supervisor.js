...
exports.getLogin = (req, res, next) => {
    if (req.session.supervisor == undefined) {
        res.render('supervisor/login', { msg: "", err: "" });
    }
    else {
        ...
        connectDB.query(data1, (err1, result1) => {
            if (err1) throw err1;
                ...
                return res.render('supervisor/index', { msg: "", err: "", data: result1 });
            }
        })
    }
...
exports.postLogin = (req, res, next) => {
    ...
    connectDB.query(data, (err, result) => {
        if (err) throw err;
            ...
            if (result.length) {
                req.session.supervisor = result[0].name;
                connectDB.query(data1, (err1, result1) => {
                    if (err1) throw err1;
                    else {
                        for (i in result1) {
                ...
                return res.render('supervisor/login', { msg: "", err: "Please Check Your Information Again" });
            }
        }
    })
}
...
exports.getAddHotel = (req, res, next) => {
    res.render('supervisor/addhotel', { msg: "", err: "" });
}
    ...
    new formidable.IncomingForm().parse(req)
        ...
        .on('fileBegin', function (name, file) {
            ...
            if (fileType == 'jpg' || fileType == 'png' || fileType == 'jpeg') {
                ...
                wrong = 1;
                res.render('supervisor/addhotel', { msg: "", err: "Wrong File type" });
            }
        })
        .on('aborted', () => {
            ...
            if (wrong == 1) {
                ...
                connectDB.query(data, (err, result) => {
                    ...
                    if (err) {
                        ...
                        res.render('supervisor/addhotel', { msg: "Data Insert Successfuly", err: "" });
                    }
                });
            }
        })
...
exports.getSearch = (req, res, next) => {
    res.render('supervisor/search', { msg: "", err: "" })
}
...
exports.postSearch = (req, res, next) => {
    ...
    connectDB.query(data, (err, result) => {
        if (err) throw err;
            ...
            return res.render('supervisor/update', { msg: "", err: "", data: result });
        }
    })
...
exports.getUpdate = (req, res, next) => {
    ...
    connectDB.query(data, (err, result) => {
        if (err) throw err;
            ...
            res.render('supervisor/updatePage', { data: result[0] });
        }
    })
}
...
exports.updatePrevData = (req, res, next) => {
    ...
    connectDB.query(data, (err, result) => {
        if (err) throw err;
            ...
            res.render('supervisor/search', { msg: "Update Done Successfuly", err: "" })
        }
    })
