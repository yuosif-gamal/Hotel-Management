...
exports.getBoysRoomsPage = (req, res, next) => {
   res.render('user/boysRooms', { user: "", msg: [], err: [] })
}
exports.getGirlRoomsPage = (req, res, next) => {
   res.render('user/girlsRooms', { user: "", msg: [], err: [] })
}
...
exports.getservices = (req, res, next) => {
    res.render('user/services', { user: req.session.mail });
}

//post request of services
exports.postservices = (req, res, next) => {
    ...
    connectDB.query(data, (err, result) => {
        if (err) throw err; //show if error found
            ...
            //console.log(result);
            return res.render('user/showservice', { user: req.session.mail, rooms: result })
        }
    });
} 

exports.postBookingservice = (req, res, next) => {
    // console.log(req.body);

    res.render('user/boookingservice.ejs', { user: req.session.mail, name: req.body.name, type: req.body.type, cost: req.body.cost });
}

exports.poststatusservices = (req, res, next) => {
    ...
    //console.log(date)
    data = "INSERT INTO bookingservices " +
        " VALUES ('" + req.session.mail + "','" + req.body.name + "','"  + req.body.cost + "','" + 0 + "','" + date + "')"
    ...
    connectDB.query(data, (err, reslt) => {
        if (err) throw err;
            ...
            connectDB.query(data1, (err1, result) => {
                ...
                res.render('user/statusservices', { user: req.session.mail, msg: "Your booking is placed", err: "", data: result });
            })
        }
    })
}
...
exports.postStatus = (req, res, next) => {
   ...
   data = "INSERT INTO bookingstatus " +
      " VALUES ('" + req.session.mail + "','" + req.body.name + "','" + req.body.type + "','" + req.body.personname + "','"+ req.body.nationalID + "','" + req.body.universityName + "','" + req.body.collegeYear + "','" + req.body.birthday + "','" + req.body.phoneNumber + "','" + req.body.stayPeriod + "','" + 0  + "')"
...
exports.deleteservice =(req,res,next)=>{
   ...
   data = "DELETE FROM bookingservices " +
   " WHERE email = " + mysql.escape(req.body.mail) +
   " AND name = " + mysql.escape(req.body.type) +
